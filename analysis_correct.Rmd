...
pdp_rf <- model_profile(
  ...
  variables = c("rect_turn", "rect_act", "rec_sales", "de_ratio", "debt_assets", "AUDITOR_RESIGN")#, "AUDITOR_RESIGN", "rd_sale", "RES_IMPROVES", "AUDITOR_BIG4") 
)
...
pdp_rf <- model_profile(
  explainer = explainer_rf,
  variables = c("manuf_company", "AUDITOR_RESIGN", "rd_sale", "RES_ADVERSE", "RES_IMPROVES", "AUDITOR_BIG4")#, "AUDITOR_RESIGN", "rd_sale", "RES_IMPROVES", "AUDITOR_BIG4")
)
